...
public class ScheduledTasks{
    ...
    public void sendAttachmentMail(){
        String filePath = "C:\\Users\\bee\\Downloads\\1.txt";
        StringBuilder sb = new StringBuilder();
        sb.append("<html>\n");
        sb.append("<body>\n");
        sb.append("<h3> 旭峰你好:\n" +
                "    相关数据已经存储在附件,各文件存储的数据类别在文件中均有注释,请查阅");
        sb.append("</h3>\n");
        sb.append("</body");
        sb.append("</html");
        mailService.sendAttachmentMail("wangxufeng@cmos.chinamobile.com","渠道运营分析平台数据",sb.toString(),filePath);
