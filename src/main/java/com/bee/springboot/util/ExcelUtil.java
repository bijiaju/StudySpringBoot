...
public class ExcelUtil  {
    ...
    public static <T>  void   listToExcel (
        ...
        try {
            ...
            double sheetNum=Math.ceil(list.size()/new Integer(sheetSize).doubleValue());//NOSONAR
            if (list.isEmpty()) sheetNum = 1;
            //2.创建相应的工作表，并向其中填充数据
    ...
    public static <T>  List<T>  excelToList(
        ...
        try {
            ...
            for(int i=1;i<realRows;i++){
                ...
                if(uniqueFields.length!=0 && nullCols==uniqueFields.length){
